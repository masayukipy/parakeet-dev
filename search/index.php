...
<head>
    <meta charset="UTF-8">
    <title>parakeet-検索結果</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta property="og:url" content="https://parakeet.website/search">
    <meta property="og:site_name" content="parakeet-音声学習">
    <meta property="og:title" content="parakeet-検索結果">
    <meta property="og:type" content="article">
    <meta property="og:locale" content="ja_JP">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:title" content="parakeet-検索結果">
...
<body>
    ...
    <main>
        <section id="menu">
            <div class="title">
                <h2><span>"<?= $_POST['search-name'] ?>"の検索結果</span></h2>
            </div>
            <div>
                <?php $result = $curriculum->getSearchDb(h($_POST['search-name'])); ?>
            </div>
            <div class="list-fleam">
                <div class="grid">
                    <?php foreach($result as $color): ?>
                    <div><a href="../play/?title=<?= h($color['title']) ?>">#<?= h($color['title']) ?>(<?= h($color['count(`title`)']) ?>)</a></div>
                    <?php endforeach ?>
                </div>
            </div>
        </section>
    ...
    <script src="../headerFixed-home&list"></script>
